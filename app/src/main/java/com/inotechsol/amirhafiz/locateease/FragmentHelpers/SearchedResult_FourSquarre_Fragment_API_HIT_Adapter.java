...
public class SearchedResult_FourSquarre_Fragment_API_HIT_Adapter extends BaseAdapter{
    Context mContext;
    ...
    public SearchedResult_FourSquarre_Fragment_API_HIT_Adapter(Context _Context){
    ...
    @Override
    public int getCount() {
        return SearchedResult_FourSquare_Fragment_API_HIT.mRootObject.response.venues.size();
    }

    @Override
    public Object getItem(int position) {
        return SearchedResult_FourSquare_Fragment_API_HIT.mRootObject.response.venues.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.detail_distance_name_txt.setText(SearchedResult_FourSquare_Fragment_API_HIT.mRootObject.response.venues.get(position).name);
