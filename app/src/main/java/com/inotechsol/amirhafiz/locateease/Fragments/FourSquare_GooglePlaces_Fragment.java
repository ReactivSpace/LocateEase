...
public class FourSquare_GooglePlaces_Fragment extends Fragment implements ViewPager.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState) {
        ...
        View frgView = inflater.inflate(R.layout.four_square_google_frg,container,false);
    ...
    public class ViewComm_Adapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragment = new FourSquarePlacesDetailDistance_Fragment();
                    break;
                case 1:
                    fragment = new GooglePlaces_DetailDistanceFragment();//
                    break;
